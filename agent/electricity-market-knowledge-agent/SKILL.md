...
网页预览必须按 Excel 的页签结构展示：基础概念、国家政策、江苏、浙江、山西、湖北、四川、山东、甘肃、安徽、更新记录。为优化阅读体验，网页使用紧凑工具栏：搜索框放在页签选择同一行前面，删除“当前页：基础概念”等单独描述区域，尽可能为表格留出高度空间；搜索框和页签固定不随页面滚动，只有表格区域滚动，表头也应保持可见。所有页签表格中的“详细解读”改为“知识摘要”，展示 200 字以内摘要；点击或鼠标悬浮知识摘要时，必须用页面内自定义浮层展示完整知识摘要，移开鼠标、点击空白处或按 Esc 时关闭浮层，不得只依赖浏览器原生 `title` 提示。旧版“政策/规则总结”口径不再作为网页表格主列，统一沉淀为“知识摘要”和完整“详细解读”。每行提供“查看详情”按钮，点击后弹窗只展示完整详细解读，不重复展示其他字段。省份页按政策文件维度展示，字段参考国家政策页，包括“文件标题、知识摘要、发文编号、发布单位、发布日期、链接、查看文件、附件归档、状态、最后核验日期”，网页表格额外提供“详情”操作列。详细解读应按文件内容灵活结构化，不使用固定模板；根据政策复杂度设置适合的小标题、条目、重点加粗或高亮，必要时可补充表格或图片等辅助说明。官方来源“链接”必须可点击并支持跳转；“链接”后必须增加“查看文件”字段，点击后在新标签页打开本地归档 PDF；同时展示“附件归档”，点击后在新标签页打开本地附件。网页应提供关键词搜索，便于按概念、政策标题、交易品种、文号或主体查找，并提供“导出 Excel”按钮，一键导出所有知识到一个 Excel。

网页展示还必须保持整体美学设计：头部使用通过 ChatGPT 图片生成能力制作的电力元素背景图，包含输电塔、电网线、数字化节点等电力市场意象；不得退回纯色背景。头部不展示英文标题，中文标题和元信息排版紧凑清晰，避免在 70px 高度内出现拥挤、错位或主次不清。页面整体采用专业、清爽、可信赖的知识库门户风格，头部固定、紧凑工具栏、搜索框和页签固定、表格区域滚动、知识摘要点击/悬浮浮层、长文本折叠、弹窗只展示详细解读、导出 Excel 按钮、链接按钮、搜索框、页签和表格层次需要保持一致的阅读体验。
