...
导出必须包含：基础概念、国家政策、江苏、浙江、山西、湖北、四川、山东、甘肃、安徽、更新记录。基础概念页必须包含“详细解读”，国家政策页必须包含“详细解读”。省份页按政策文件维度展示，不再按交易品种拆成规则表，字段参考国家政策页，包括“文件标题、详细解读、发文编号、发布单位、发布日期、链接、查看文件、附件归档、状态、最后核验日期”。来源相关页面必须包含“查看文件”和“附件归档”。不得用未经核验的内容填充空白数据。
...
网页预览必须按 Excel 的页签结构展示：基础概念、国家政策、江苏、浙江、山西、湖北、四川、山东、甘肃、安徽、更新记录。为优化阅读体验，长文本列（如“详细解读”“政策/规则总结”“适用对象”“管理要求”“准入条件”“参与流程”“考核方式”）默认折叠为摘要，不在表格中全部铺开；每行提供“查看详情”按钮。头部固定，高度约 70px；搜索框和页签固定不随页面滚动；只有表格区域滚动，表头也应保持可见。省份页按政策文件维度展示，字段参考国家政策页，包括“文件标题、详细解读、发文编号、发布单位、发布日期、链接、查看文件、附件归档、状态、最后核验日期”，网页表格额外提供“详情”操作列。点击“查看详情”后，弹窗只展示详细解读，不重复展示其他字段。详细解读应按文件内容灵活结构化，不使用固定模板；根据政策复杂度设置适合的小标题、条目、重点加粗或高亮，必要时可补充表格或图片等辅助说明。官方来源“链接”必须可点击并支持跳转；“链接”后必须增加“查看文件”字段，点击后在新标签页打开本地归档 PDF；同时展示“附件归档”，点击后在新标签页打开本地附件。网页应提供关键词搜索，便于按概念、政策标题、交易品种、文号或主体查找。

网页展示还必须保持整体美学设计：头部使用通过 ChatGPT 图片生成能力制作的电力元素背景图，包含输电塔、电网线、数字化节点等电力市场意象；不得退回纯色背景。头部不展示英文标题，中文标题和元信息排版紧凑清晰，避免在 70px 高度内出现拥挤、错位或主次不清。页面整体采用专业、清爽、可信赖的知识库门户风格，头部固定、搜索框和页签固定、表格区域滚动、长文本折叠、弹窗只展示详细解读、链接按钮、搜索框、页签和表格层次需要保持一致的阅读体验。
